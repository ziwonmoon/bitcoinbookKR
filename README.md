...
이 저장소에는 오라일리 미디어(O'Reilly Media)가 종이책과 전자책으로 출간한 『마스터링 비트코인』 세 개 판본의 전체 원문이 담겨 있습니다. 판본마다 적용되는 오픈 라이선스가 다르므로 [LICENSE](LICENSE)를 확인하세요. 세 판본은 다음과 같습니다.

* 2014년 12월에 출간된 [제1판 2쇄](https://github.com/bitcoinbook/bitcoinbook/releases/tag/Edition1Print2)
* 2018년 3월에 출간된 [제2판 3쇄](https://github.com/bitcoinbook/bitcoinbook/releases/tag/second_edition_print3)
* 2023년 12월에 출간된 [제3판 1쇄](https://github.com/bitcoinbook/bitcoinbook/releases/tag/third_edition_print1)

# 이 책 읽기

이 책을 *무료로* 읽으려면 [BOOK.md](BOOK.md)를 보세요. 각 장을 클릭하면 브라우저에서 바로 읽을 수 있습니다.

_각 장에 있는 일부 링크는 깃허브에서 읽을 때 동작하지 않습니다. 해당 링크들은 종이책과 전자책 판본을 위한 것이라 모든 장이 함께 렌더링될 때만 동작하기 때문입니다. 아쉽게도 깃허브는 책 전체를 한 번에 렌더링하는 기능을 제공하지 않습니다._

# 마스터링 비트코인 제3판

*『마스터링 비트코인: 오픈 블록체인 프로그래밍 (제3판)』*은 전 세계 여러 서점에서 종이책과 전자책으로 판매되고 있습니다. 예를 들면 다음과 같습니다.
...
[third_edition_print_1](https://github.com/bitcoinbook/bitcoinbook/releases/tag/third_edition_print1) 태그는 오라일리 미디어가 2023년 12월에 종이책과 전자책으로 출간한 『마스터링 비트코인』 제3판 1쇄에 해당합니다.
...
[Edition1Print1](https://github.com/bitcoinbook/bitcoinbook/releases/tag/Edition1Print1), [Edition1Print2](https://github.com/bitcoinbook/bitcoinbook/releases/tag/Edition1Print2) 태그는 오라일리 미디어가 출간한 『마스터링 비트코인』 제1판의 두 개 쇄에 해당합니다.
...
제2판을 바탕으로 한 『마스터링 비트코인(오픈 제2판)』은 https://aantonop.com 에서 영어와 스페인어로도 볼 수 있습니다. 『마스터링 비트코인』 제2판은 각국 출판사를 통해 독일어, 폴란드어, 일본어, 한국어, 중국어 등으로도 출간되었습니다.

# 이슈, 오류, 의견, 기여

이 책에 기여하려면 [CONTRIBUTING.md](CONTRIBUTING.md)를 보세요. 모든 기여는 본인의 창작물이어야 하며 퍼블릭 도메인(CC0) 또는 저작자표시(CC-BY) 라이선스로 제공되어야 합니다. 풀 리퀘스트에 github_contrib.asciidoc 파일을 수정하는 방식으로 본인의 저작자 표시를 포함해야 합니다.

수정 사항을 풀 리퀘스트로 기여하는 방법을 안다면, 고쳐 쓴 내용을 [develop 브랜치](https://github.com/bitcoinbook/bitcoinbook/tree/develop)에 대한 풀 리퀘스트로 제출해 검토를 요청해 주세요. 여러 가지를 고칠 때는 체리픽이나 충돌 해결이 쉽도록 각각을 별도의 커밋으로 나눠 주세요. 그 외의 경우에는 오류나 의견을 설명하는 이슈를 올려 주세요. 대규모 변경이나 새로운 내용을 기여하고 싶다면 먼저 저자와 조율해 주세요. 연락처는 저자의 웹사이트 https://aantonop.com/ 에서 찾을 수 있습니다.

# 번역

이 책의 번역에 관심이 있다면 https://www.transifex.com/bitcoinbook/mastering-bitcoin/ 에서 자원봉사 팀에 합류해 주세요.
